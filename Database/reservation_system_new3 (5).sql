...
--
-- Host: 127.0.0.2
-- Generation Time: Oct 16, 2024 at 01:19 PM
...
INSERT INTO `closingperiods` (`closing_period_id`, `venue_id`, `court_id`, `date_type`, `start_date`, `end_date`, `reason`, `created_at`, `updated_at`, `start_time`, `end_time`) VALUES
(1, 1, NULL, 1, '2024-10-16', '2024-11-15', 'Annual Maintenance', '2024-10-02 06:21:49', '2024-10-16 04:01:07', '00:00:00', '00:24:00'),
(2, 2, NULL, 12, '2024-10-16', '2024-11-06', 'Facility Upgrade', '2024-10-02 06:21:49', '2024-10-16 03:53:48', '00:00:00', '00:00:00');
...
--
-- Table structure for table `courtcost`
--

CREATE TABLE `courtcost` (
  `courtcost_id` int(11) NOT NULL,
  `courtcost_starttime` time NOT NULL,
  `courtcost_endtime` time NOT NULL,
  `courtcost_cost` decimal(10,2) NOT NULL,
  `courtcost_courtid` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `courtcost`
--

INSERT INTO `courtcost` (`courtcost_id`, `courtcost_starttime`, `courtcost_endtime`, `courtcost_cost`, `courtcost_courtid`) VALUES
(1, '07:00:00', '08:30:00', '60.00', 1);
...
(1, 1, NULL, '2024-10-16', 'Christmas Day - Closed', '2024-10-02 06:21:43', '2024-10-16 04:14:46', 1, NULL),
...
--
-- Indexes for table `courtcost`
--
ALTER TABLE `courtcost`
  ADD PRIMARY KEY (`courtcost_id`),
  ADD KEY `fk_courtcost_courtid` (`courtcost_courtid`);
...
--
-- AUTO_INCREMENT for table `courtcost`
--
ALTER TABLE `courtcost`
  MODIFY `courtcost_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Constraints for table `courtcost`
--
ALTER TABLE `courtcost`
  ADD CONSTRAINT `fk_courtcost_courtid` FOREIGN KEY (`courtcost_courtid`) REFERENCES `court` (`court_id`) ON DELETE CASCADE ON UPDATE CASCADE;
